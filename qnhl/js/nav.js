...
$(function(){
  ...
  $('.submenu li').click(function () {
	...
	$(".ejlink").click(function(){
						$(this).parent().find('.sjsubmenu').slideDown(300);
						$(this).parent().siblings().find('.sjsubmenu').slideUp(300);
			});
    ...
    //     $(this).next('.sjsubmenu').slideUp();
    //   }else{
    //     $(this).addClass('hover');
    //     $(this).next('.sjsubmenu').slideDown();
    //   }
		//
    // });
