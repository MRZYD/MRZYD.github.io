...
shop.api.fetchHotGoods(1,5,function(response){
  var html = '';
...
var recommendDiv = document.querySelector('.recommend-Ajax');
var recommendUl2 = document.querySelector('.recommend-ul2');
// console.log(recommendDiv,recommendUl);
shop.api.fetchHotGoods(6,5,function(response){
  var html = '';
  for(var i = 0;i<response.data.length;i++){
    var obj = response.data[i];
    html+='<li>'
  ...
  recommendUl2.innerHTML = html;
})

var recommendDiv = document.querySelector('.recommend-Ajax');
var recommendUl3 = document.querySelector('.recommend-ul3');
// console.log(recommendDiv,recommendUl);
shop.api.fetchHotGoods(11,5,function(response){
  var html = '';
  for(var i = 0;i<response.data.length;i++){
    var obj = response.data[i];
    html+='<li>'
...
//sectionCarousel.style.backgroundImage = 'url(images/carousel'+newIdx+'.jpg)';
//},3000)
