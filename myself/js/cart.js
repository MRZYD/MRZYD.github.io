...
if(json.message == "用户Token无效"){
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    oTable.innerHTML += `<tr>
                        ...
                        <td class="price">${obj.goods_price}元</td>
                        <td class="total" name="sum">${obj.goods_sum}元</td>
                        <td class="oper"><input data-id="${obj.goods_id}" type="button" name="delete" value="删除"></td>
                      </tr>`;
  }
  getSum();
});
